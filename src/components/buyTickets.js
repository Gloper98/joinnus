...
const BuyTickets = ({seats, total, selected, showSeats, number, showSeatsState, hideSeats}) => {
  ...
  <h3 className="grey-text text-darken-3">Jockey Club Esplanade</h3>
  </div>
  ...
  <li>
    <div className="collapsible-header">
      ...
      First
      <span className="badge blue"></span></div>
    <div className="collapsible-body"><p>Lorem ipsum dolor sit amet.</p></div>
  </li>
  <li>
    <div className="collapsible-header">
      <i className="material-icons">assistant</i>
        Lower Right Mezzanne
      <span className="badge purple"></span></div>
    <div className="collapsible-body"><p>Lorem ipsum dolor sit amet.</p></div>
  </li>
  <li>
    <div className="collapsible-header">
  ...
  <li>
    <div className="collapsible-header">
      ...
      Second
      <span className="badge red"></span></div>
    <div className="collapsible-body"><p>Lorem ipsum dolor sit amet.</p></div>
  </li>
</ul>
    </div>
          ...
          <div className="card-action">
            <div className="collection">
              {seats.map((seat)=>{
                if(seat.color === 'lime'){
                  return(
                    <a href="#!" className="collection-item" key={seat.code}>Zone: {seat.zone}<p>ROW: {seat.row}</p><p>COLUMN: {seat.column}</p><span className="new badge price">$ {seat.value}.00</span>category: {seat.category}</a>
                  )
                }
              })}
          </div>
